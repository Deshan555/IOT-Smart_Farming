...
public class HeatIndex_Chart
{
    ...
    public static void update_dataPanel()
    {
        ...
        try
        {
            ...
            UI.Sensor_Box_Draw.jTextArea4.append(box_a.load_condition("Record_Time")+"\t\t\tHeatIndex / WindChil: "+box_a.load_condition("Heat_Index")+"F\n\n");
        }
    ...
    public static void update_chart()
    {
        ...
        try
        {
            list.add(new ModelChartLine("Data", Double.parseDouble(box_a.load_condition("Heat_Index"))));
        }
        catch(Exception error)
        {
            Core.Background.Bugs_Log.exceptions(String.valueOf(error));
        ...
        UI.Sensor_Box_Draw.chart_3.setModel(list);
    }
