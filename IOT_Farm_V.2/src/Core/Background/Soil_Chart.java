...
public class Soil_Chart
{
    ...
    public static void get_level()
    {
        ...
        try
        {
            data = Integer.valueOf(box_b.load_condition("Soil_Moisture"));
        }
        ...
        if(data > 80)
        {
            UI.Sensor_Box_Draw.progress3.setForeground(Color.BLUE);
            
            //UI.Sensor_Box_Draw.progress2.setBackground(Color.WHITE);
        }
        else if((data < 80)&&(data >50))
        {
            UI.Sensor_Box_Draw.progress3.setForeground(Color.GREEN);
        }
        else if(data < 50)
        {
            UI.Sensor_Box_Draw.progress3.setForeground(Color.RED);
